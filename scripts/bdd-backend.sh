...
npx cucumber-js -f json:test/reports/cucumber_report.json --require-module @babel/register --require-module @babel/polyfill --require spec/cucumber/steps $cucumberSpec